Accel_World_Agent_Simulator Executable
...
================================
-run_Accel_World_Agent_Simulator.sh (shell script for temporarily setting environment 
 variables and executing the application)
   -to run the shell script, type
   
       ./run_Accel_World_Agent_Simulator.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v96, run the shell script as:
       ...
       ./run_Accel_World_Agent_Simulator.sh /mathworks/home/application/v96
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_Accel_World_Agent_Simulator.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure Accel_World_Agent_Simulator.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r Accel_World_Agent_Simulator.zip Accel_World_Agent_Simulator.app
    or the tar command 
    tar -cvf Accel_World_Agent_Simulator.tar Accel_World_Agent_Simulator.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v96/runtime/maci64:MR/v96/sys/os/maci64:MR/v96/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_Accel_World_Agent_Simulator.sh 
